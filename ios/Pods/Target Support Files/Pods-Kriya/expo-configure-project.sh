...
with_node \
  ...
  --target "/Users/saaketsurya/Desktop/kriya1/ios/Pods/Target Support Files/Pods-Kriya/ExpoModulesProvider.swift" \
  --entitlement "/Users/saaketsurya/Desktop/kriya1/ios/Kriya/Kriya.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-audio" "expo-constants" "expo-device" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-media-library" "expo-notifications" "expo-router" "expo-splash-screen" "expo-sqlite" "expo-system-ui"
